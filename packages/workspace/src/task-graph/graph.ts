...
type TerminalDelegationStatus = "succeeded" | "failed" | "cancelled";

export interface TaskGraphNode {
	id: string;
	status: DelegationStatus;
	agent: string;
	category?: DelegationRecord["category"];
...
function compareRecords(a: DelegationRecord, b: DelegationRecord): number {
