...
export const LSP_INSTALL_HINTS: Record<string, string> = {
	...
	julials:
		"Install Julia and LanguageServer.jl (https://julialang.org/downloads/)",
...
export const BUILTIN_SERVERS: Record<string, Omit<LSPServerConfig, "id">> = {
	...
	julials: {
		command: [
			...
			"--quiet",
			"-e",
			'import Pkg; if Base.find_package("LanguageServer") === nothing; Pkg.add("LanguageServer"); end; using LanguageServer; runserver()',
		],
		extensions: [".jl"],
	},
	"kotlin-ls": {
