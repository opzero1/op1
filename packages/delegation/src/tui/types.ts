 ...
 *
 * The installed @opencode-ai/plugin SDK does not ship a /tui subpath yet,
 * so we define just enough type structure for the delegation TUI plugin to
 * compile. These types mirror the upstream TuiPluginApi shape and will be
 * replaced by the real import once the SDK publishes it.
 */

/** Opaque JSX.Element stand-in — the host provides the real type at runtime. */
