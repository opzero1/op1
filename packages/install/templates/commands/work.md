...
- Treat the saved file change map in `plan_context_read` as the canonical add/edit/delete contract for touched files; do not reopen file scope unless repo reality conflicts with it
